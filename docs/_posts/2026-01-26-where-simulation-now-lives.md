...
![Where Simulation Now Lives](/assets/images/biounfold-017-where-simulation-now-lives.png){: width="90%"}
...
Machine learning did not introduce a new biological grammar.
It turned an existing one into an interactive object.
